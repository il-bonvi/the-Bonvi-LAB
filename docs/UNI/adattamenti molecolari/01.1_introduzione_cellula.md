...
### TABELLA 15–3 ALCUNE SEQUENZE SEGNALE TIPICHE

| Funzione del segnale | Esempio di sequenza segnale con proprietà chimiche |
| :--- | :--- |
...
### 🎨 Legenda dei Colori (Emoji):

* 🔴 **Amminoacidi carichi positivamente** *(basici: Lisina/Lys, Arginina/Arg)* &rarr; Attirano le cariche negative.
* 🔵 **Amminoacidi carichi negativamente** *(acidi: Acido glutammico/Glu, Acido aspartico/Asp)* &rarr; Attirano le cariche positive.
* 🟢 **Amminoacidi idrofobici importanti** *(idrorepellenti: Leucina/Leu, Isoleucina/Ile, Valina/Val, Fenilalanina/Phe, Triptofano/Trp, Alanina/Ala, Metionina/Met, Glicina/Gly)* &rarr; Amano stare in mezzo ai grassi delle membrane.

* *Nota:* **<sup>+</sup>H₃N** indica l'estremità *N-terminale* (l'inizio della proteina); **COO⁻** indica l'estremità *C-terminale* (la fine della proteina).
