...
graph LR
    ...
    classDef adaL1 fill:#74b9ff,stroke:#0984e3,stroke-width:2px,font-weight:bold;
    classDef adaL2 fill:#e0f2fe,stroke:#74b9ff,stroke-width:1.5px;

    classDef stratL1 fill:#a55edd,stroke:#8854d0,stroke-width:2px,font-weight:bold;
    classDef stratL2 fill:#f3e8ff,stroke:#a55edd,stroke-width:1.5px;

    Ip((Allenamento in<br/>ipossia controllata)):::root

    Ip --> Ada([Adattamenti indotti]):::adaL1
    Ada --> AdaCardio([Cardio-respiratori:<br/>ventilazione, EPO, HIF]):::adaL2
    Ada --> AdaMusc([Muscolari/cellulari:<br/>capillari, mitocondri, HIF-1α]):::adaL2

    Ip --> Strat([Strategie]):::stratL1
    Strat --> StratLHTH([LHTH: massimo stimolo,<br/>bassa qualità sedute]):::stratL2
    Strat --> StratLHTL([LHTL: più usata,<br/>alto stimolo + qualità]):::stratL2
    Strat --> StratInt([Intermittente:<br/>maschera, stress breve]):::stratL2
    Strat --> StratHipo([Ipoventilazione:<br/>tolleranza a CO2]):::stratL2
```
