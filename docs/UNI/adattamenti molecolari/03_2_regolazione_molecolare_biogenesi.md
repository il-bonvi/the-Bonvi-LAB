...
![alt text](images/3/schema_2.png)
...
![alt text](images/3/tfam_stimuli.png)
...
![alt text](images/3/signal_act_pgc-1.png)
...
![alt text](images/3/mito_enzy_bio.png)
...
![alt text](images/3/mito_sche_2.png)
...
![alt text](images/3/cascata_ca.png)
...
![alt text](images/3/schema_topi_again.png)
...
![alt text](images/3/schema_ad_cum.png)
...
graph LR
    ...
    classDef tfamL1 fill:#74b9ff,stroke:#0984e3,stroke-width:2px,font-weight:bold;
    classDef tfamL2 fill:#e0f2fe,stroke:#74b9ff,stroke-width:1.5px;

    classDef pgcL1 fill:#a55edd,stroke:#8854d0,stroke-width:2px,font-weight:bold;
    classDef pgcL2 fill:#f3e8ff,stroke:#a55edd,stroke-width:1.5px;

    classDef sensL1 fill:#ff7f50,stroke:#ff6348,stroke-width:2px,font-weight:bold;
    classDef sensL2 fill:#ffeaa7,stroke:#fdcb6e,stroke-width:1.5px;

    classDef postL1 fill:#2ed573,stroke:#26af58,stroke-width:2px,font-weight:bold;
    classDef postL2 fill:#e3fcef,stroke:#a3e9c9,stroke-width:1.5px;

    Reg((Regolazione molecolare<br/>della biogenesi<br/>mitocondriale)):::root

    Reg --> Tfam([TFAM]):::tfamL1
    Tfam --> TfamT([Trascrizione e replicazione<br/>del mtDNA]):::tfamL2
    Tfam --> TfamK([KO → miopatia,<br/>indotto dall'esercizio]):::tfamL2

    Reg --> Pgc([Asse PGC-1/NRF]):::pgcL1
    Pgc --> PgcNrf([NRF1/2 → trascrizione<br/>geni mitocondriali + TFAM]):::pgcL2
    Pgc --> PgcMef([Loop PGC-1/MEF2:<br/>feed-forward]):::pgcL2

    Reg --> Sens([Sensori dell'esercizio]):::sensL1
    Sens --> SensAmpk([AMPK: sensore energetico<br/>AMP/ATP]):::sensL2
    Sens --> SensCa([Ca2+: CaN, CaMK, p38]):::sensL2
    Sens --> SensP53([p53: via PGC-1-dip.<br/>e indip.]):::sensL2

    Reg --> Post([Controllo post-trascrizionale]):::postL1
    Post --> PostmRNA([Stabilità mRNA<br/>citocromo c]):::postL2
    Post --> PostImp([Import mitocondriale:<br/>Tom20, chaperone]):::postL2
```
