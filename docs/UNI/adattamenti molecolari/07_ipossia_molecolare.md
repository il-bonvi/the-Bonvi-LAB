...
graph LR
    ...
    classDef step fill:#74b9ff,stroke:#0984e3,stroke-width:2px,font-weight:bold;

    Hif((HIF-1α<br/>stabilizzato)):::root
    Hif --> S1([1. ↑GLUT1/3:<br/>assorbimento glucosio]):::step
    Hif --> S2([2. ↑LDH-A, MCT4, NHE1:<br/>glicolisi e pH]):::step
    Hif --> S3([3. ↑GYS1, UGP2, GBE1:<br/>glicogenosintesi]):::step
    Hif --> S4([4. ↑PDK1 ⊣ PDH:<br/>blocco Krebs]):::step
    Hif --> S5([5. ↑BNIP3/BNIP3L:<br/>mitofagia]):::step
    Hif --> S6([6. COX4-i2, NDUFA4L2,<br/>miR-210: ↓ROS]):::step
    Hif --> S7([7. Carbossilazione<br/>riduttiva: ↑lipidi]):::step
```
