...
graph LR
    ...
    classDef eqL1 fill:#74b9ff,stroke:#0984e3,stroke-width:2px,font-weight:bold;
    classDef eqL2 fill:#e0f2fe,stroke:#74b9ff,stroke-width:1.5px;
    ...
    classDef stuL1 fill:#ff7f50,stroke:#ff6348,stroke-width:2px,font-weight:bold;
    classDef stuL2 fill:#ffeaa7,stroke:#fdcb6e,stroke-width:1.5px;

    Ip((Equilibrio<br/>anabolismo-catabolismo<br/>e miochine)):::root

    Ip --> Eq([Bilancia anabolismo/catabolismo]):::eqL1
    Eq --> EqAna([Attività, IGF-1, mTOR,<br/>cellule satelliti]):::eqL2
    Eq --> EqCat([Miostatina, glucocorticoidi,<br/>ROS, UPS, FoxO]):::eqL2

    Ip --> Mio([Miochine]):::mioL1
    Mio --> MioEndo([Funzione endocrina:<br/>organi a distanza]):::mioL2
    Mio --> MioPara([Funzione para/autocrina:<br/>nel muscolo stesso]):::mioL2

    Ip --> Stu([IGF-1 vs Miostatina]):::stuL1
    Stu --> StuIgf([IGF-1 locale:<br/>↑massa, ↓atrofia da età]):::stuL2
    Stu --> StuMstn([Miostatina assente:<br/>ipertrofia + iperplasia]):::stuL2
    Stu --> StuSyn([Combinati: effetto<br/>sinergico]):::stuL2
```
